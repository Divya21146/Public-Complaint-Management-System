...
tr td:first-child:before{
  ...
  <table  style="margin: 0 auto; width: 95%; border: 1px solid #ccc;" class="table">
    ...
    <tr>
      ...
      <td scope="row"></td>
            ...
            $qry=mysqli_query($conn,"select * from transport where cat='$cat'");
  ...
  $num=mysqli_query($conn,"select * from transport");
  if ($num) {
    $count=mysqli_num_rows($qry);
  }
  ?>
    ...
    $qry1=mysqli_query($conn, "delete from trans_add WHERE id='$id'");
    if($qry1)
    {
    header("location:t_mcategory.php");
