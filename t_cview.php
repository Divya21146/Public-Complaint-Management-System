...
<div class="col-sm-6">
  <form style="box-shadow: 3px 3px 7px rgba(143, 0, 255, 0.8); margin-top: 40px; margin-left:50px; margin-right:150px; border: 1px solid blueviolet; padding: 30px; border-radius: 30px 10px;" class="mb-4" method="post" autocomplete="off">
    <h2 style="margin: 10px; margin-bottom: 37px;" class="h1-responsive font-weight-bold text-center my-4">USER DETAIL</h2>
