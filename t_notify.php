...
$test="not_seen";
 $qry=mysqli_query($conn,"select * from tfeed where seen='$test'");
...
<a style="text-decoration:none;" href='t_afeedview.php?id=<?php echo $row['id']?>'>
  <div class="card">
...
$test1="not_seen";
 $notify=mysqli_query($conn,"select * from transport where seen='$test'");
...
<a style="text-decoration:none;" href='tview.php?id=<?php echo $row1['id']?>'>
  <div class="card">
