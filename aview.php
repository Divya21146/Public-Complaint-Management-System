...
?>
	...
	<div class="col-sm-6" style=" margin-bottom:10px; border-right: 1px solid black;">
  		<form style=" margin-left:50px; margin-right:50px;" class="mb-4" method="post">
  ...
  if(isset($_POST['action']))
{
  ...
  $seen="seen";
  $status="inprogress";
  $qry3 = mysqli_query($conn, "UPDATE agriculture SET status='$status',seen='$seen' WHERE id='$id' ");
