...
$qry1=mysqli_query($conn,"select * from health_add where cat='$cat'");
...
else
{
  ...
  $qry=mysqli_query($conn,"insert into health_add values ('','$cat', '$date')");
    if($qry)
      {
...
?>
     ...
     <button class="log" type="submit" name="btn">add</button><br><br>
      </form>
