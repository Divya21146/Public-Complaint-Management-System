...
$test="not_seen";
 $qry=mysqli_query($conn,"select * from afeed where seen='$test'");
...
<a style="text-decoration:none;" href='a_afeedview.php?id=<?php echo $row['id']?>'><div class="card">
...
$test1="not_seen";
 $notify=mysqli_query($conn,"select * from agriculture where seen='$test'");
...
<a style="text-decoration:none;" href='aview.php?id=<?php echo $row1['id']?>'><div class="card">
