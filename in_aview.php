...
?>
 ...
 <?php  
  ...
  $folder="upload/";
  $folder1="images/";
  $qry=mysqli_query($conn,"select * from agriculture where id='$id'");
  $update=mysqli_query($conn,"update agriculture set seen='$seen' where id = '$id'");
  ...
  if(isset($_POST['action']))
{
  ...
  $status="closed";
  $cseen="not_seen";
  $qry3 = mysqli_query($conn, "UPDATE agriculture SET status='$status',cseen='$cseen' WHERE id='$id' ");
$qry7= mysqli_query($conn,"select * from agriculture where id='$id'");
...
if($qry3)
{
header("location:a_inprogress.php");
}
else
{
