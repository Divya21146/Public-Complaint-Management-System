...
$status2="closed";
  ...
  if ($qry) {
    ...
    $qry1=mysqli_query($conn,"select * from regcomplaint WHERE status='$status1' && umail='$umail'");
    if ($qry1) {
    $count1=mysqli_num_rows($qry1);
  }
  $qry2=mysqli_query($conn,"select * from regcomplaint WHERE status='$status2' && umail='$umail'");
    if ($qry2) {
...
.card:active {
  ...
  <div>
    ...
    <h2 style="text-align:center;">COMPLAINT STATUS</h2>
    <div style="margin-left: 230px; margin-top: 50px;">
<a href="unot.php"><div class="card">Not yet processed<br><?php echo $count; ?></div></a>
<a href="inprogress.php"><div class="card">In progress<br><?php echo $count1; ?></div></a>
<a href="uclose.php"><div class="card">Closed complaint<br><?php echo $count2; ?></div></a>
</div>
  </div>
