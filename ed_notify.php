...
$test="not_seen";
 $qry=mysqli_query($conn,"select * from edfeed where seen='$test'");
...
<a style="text-decoration:none;" href='ed_afeedview.php?id=<?php echo $row['id']?>'>
  <div class="card"><p>You received a new feedback
...
$test1="not_seen";
 $notify=mysqli_query($conn,"select * from education where seen='$test'");
...
<a style="text-decoration:none;" href='edview.php?id=<?php echo $row1['id']?>'>
  <div class="card"><p>You received a new complaint from <b>"<?php echo $row1['cat']; ?>"</b>"</p></div>
</a>
