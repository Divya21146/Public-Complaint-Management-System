...
button:hover::before {
  ...
  <body style="background-color: #eaf6f6;">
    ...
    <li><a href="h_notify.php">dashboard</a></li>
    <li><a href="healthpost.php">posts</a></li>
    <li><a href="a_health.php">Complaint status</a></li>
      <li class="dropdown">
      <a class="dropdown-toggle" data-toggle="dropdown" href="#">Manage Complaints<span class="caret"></span></a>
        <ul class="dropdown-menu">
      <li><a href="h_not.php">Not yet processed</a></li>
              <li><a href="h_inprogress.php"> In progress</a></li>
              <li><a href="h_close.php">Closed complaints</a></li>
            </ul>
          </li>
        <li class="dropdown">
      <a class="dropdown-toggle" data-toggle="dropdown" href="#">Category<span class="caret"></span></a>
        <ul class="dropdown-menu">
      <li><a href="h_add.php">add category</a></li>
              <li><a href="h_mcategory.php">manage category</a></li>
            </ul>
          </li>
          <li><a href="h_umanage.php">manage users</a></li>
          <li><a href="a_hfeed.php">feedback</a></li>
        </ul>
...
?>
 ...
 <?php  
  ...
  $folder="upload/";
   $folder1="images/";
  $qry=mysqli_query($conn,"select * from health where id='$id'");
  $update=mysqli_query($conn,"update health set seen='$seen' where id = '$id'");
  ...
  if(isset($_POST['action']))
{
  ...
  $status="closed";
  $cseen="not_seen";
  $qry3 = mysqli_query($conn, "UPDATE health SET status='$status',cseen='$cseen' WHERE id='$id' ");
$qry7= mysqli_query($conn,"select * from health where id='$id'");
...
if($qry3)
{
header("location:h_inprogress.php");
}
else
{
...
?>
  ...
  $umail=$row['umail'];
  ?>
  <button class="btn btn-success" name="action" onclick="return msg()">Close</button></form><br>
  </div>
  <div class="col-sm-6">
