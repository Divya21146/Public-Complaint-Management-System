...
?> 
 ...
 <?php  
  ...
  $update=mysqli_query($conn,"update general set seen='$seen' where id = '$id'");
  ...
  if(isset($_POST['action']))
{
  ...
  $status="closed";
  $cseen="not_seen";
  $qry3 = mysqli_query($conn, "UPDATE general SET status='$status',cseen='$cseen' WHERE id='$id' ");
$qry7= mysqli_query($conn,"select * from general where id='$id'");
...
if($qry3)
{
header("location:g_inprogress.php");
}
else
{
