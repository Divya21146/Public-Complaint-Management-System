...
button:hover::before {
  ...
  <body style="background-color: #eaf6f6;">
    ...
    <li><a href="en_notify.php">dashboard</a></li>
    <li><a href="envipost.php">posts</a></li>
    <li><a href="a_envi.php">Complaint status</a></li>
      <li class="dropdown">
      <a class="dropdown-toggle" data-toggle="dropdown" href="#">Manage Complaints<span class="caret"></span></a>
        <ul class="dropdown-menu">
      <li><a href="en_not.php">Not yet processed</a></li>
              <li><a href="en_inprogress.php"> In progress</a></li>
              <li><a href="en_close.php">Closed complaints</a></li>
            </ul>
          </li>
        <li class="dropdown">
      <a class="dropdown-toggle" data-toggle="dropdown" href="#">Category<span class="caret"></span></a>
        <ul class="dropdown-menu">
      <li><a href="en_add.php">add category</a></li>
              <li><a href="en_mcategory.php">manage category</a></li>
            </ul>
          </li>
          <li><a href="en_umanage.php">manage users</a></li>
          <li><a href="a_enfeed.php">feedback</a></li>
        </ul>
...
<div class="col-sm-6" style="margin-bottom:10px; border-right: 1px solid black;">
 ...
 <?php  
  ...
  $folder="upload/";
   $folder1="images/";
  $qry=mysqli_query($conn,"select * from environment where id='$id'");
  $update=mysqli_query($conn,"update environment set seen='$seen' where id = '$id'");
  ...
  if(isset($_POST['action']))
{
  ...
  $status="closed";
  $cseen="not_seen";
  $qry3 = mysqli_query($conn, "UPDATE environment SET status='$status',cseen='$cseen' WHERE id='$id' ");
$qry7= mysqli_query($conn,"select * from environment where id='$id'");
while ($rit=mysqli_fetch_array($qry7)) {
  $cdetail=$rit['cdetail'];
  $umail=$rit['umail'];
$qry1 = mysqli_query($conn, "UPDATE regcomplaint SET status='$status',cseen='$cseen' WHERE cdetail='$cdetail'&& umail='$umail' ");
}
 

if($qry3)
{
header("location:en_inprogress.php");
}
else
{
...
?>
  ...
  $umail=$row['umail'];
  ?>
  <button class="btn btn-success btn-sm" name="action" onclick="return msg()">Close</button></form><br>
  </div>
  <div class="col-sm-6">
...
?>
  ...
  <script type="text/javascript">function msg(){alert("Complaint closed successfully");
return true;}</script>
