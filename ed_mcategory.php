...
tr td:first-child:before{
  ...
  <table  style="margin: 0 auto; width: 95%; border: 1px solid #ccc;" class="table">
    ...
    <tr>
      ...
      <td scope="row"></td>
            ...
            $qry=mysqli_query($conn,"select * from education where cat='$cat'");
  ...
  $num=mysqli_query($conn,"select * from education");
  if ($num) {
    $count=mysqli_num_rows($qry);
  }
  ?>
    ...
    $qry1=mysqli_query($conn, "delete from edu_add WHERE id='$id'");
    if($qry1)
    {
    header("location:ed_mcategory.php");
