...
$test="not_seen";
 $qry=mysqli_query($conn,"select * from mfeed where seen='$test'");
...
<a style="text-decoration:none;" href='m_afeedview.php?id=<?php echo $row['id']?>'>
  <div class="card">
...
$test1="not_seen";
 $notify=mysqli_query($conn,"select * from municipal where seen='$test'");
...
<a style="text-decoration:none;" href='mview.php?id=<?php echo $row1['id']?>'>
  <div class="card">
