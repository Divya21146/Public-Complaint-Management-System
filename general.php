...
button:hover::before {
  ...
  <body style="background-color: #eaf6f6;">
    ...
    <li><a href="general.php">Post complaint</a></li>
    <li><a href="gfeed.php">Feedback</a></li>
  </ul>
    ...
    if (isset($_POST['btn'])) {
     ...
     $date = date('Y-m-d H:i:s');
      $qry1=mysqli_query($conn,"select * from general_add");
  ...
  $qry=mysqli_query($conn,"insert into general values('','$umail','$department','$cat', '$ctitle','$cdetail','$file_name','$district','$place','$status','$date','$seen','$cseen','$file_name1')");
if($qry)
{
...
?>
	 ...
	 <form style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3); margin-top: 40px; margin-left:195px; margin-right:195px; border: 1px solid #ccc; padding: 30px; border-radius: 10px;" class="mb-4" method="post" enctype="multipart/form-data" action="general.php" autocomplete="off">
