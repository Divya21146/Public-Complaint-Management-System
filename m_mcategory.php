...
tr td:first-child:before{
  ...
  <table  style="margin: 0 auto; width: 95%; border: 1px solid #ccc;" class="table">
    ...
    <tr>
      ...
      <td scope="row"></td>
            ...
            $qry=mysqli_query($conn,"select * from municipal where cat='$cat'");
  ...
  $num=mysqli_query($conn,"select * from municipal");
  if ($num) {
    $count=mysqli_num_rows($qry);
  }
  ?>
    ...
    $qry1=mysqli_query($conn, "delete from muni_add WHERE id='$id'");
    if($qry1)
    {
    header("location:m_mcategory.php");
