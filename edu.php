...
button:hover::before {
  ...
  <body style="background-color: #eaf6f6;">
    ...
    <li><a href="edu.php">Post complaint</a></li>
    <li><a href="edfeed.php">Feedback</a></li>
  </ul>
    <form method="get"><button class="back" name="logout">Logout</button><br><br></form>
  </div>
</nav>
  ...
  $qry=mysqli_query($conn,"insert into education values('','$umail','$department','$cat', '$ctitle','$cdetail','$file_name','$district','$place','$status','$date','$seen','$cseen','$file_name1')");
if($qry)
{
...
?>
		...
		<form style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3); margin-top: 40px; margin-left:195px; margin-right:195px; border: 1px solid #ccc; padding: 30px; border-radius: 10px;" class="mb-4" method="post" enctype="multipart/form-data" action="edu.php" autocomplete="off">
  ...
  <?php
  $qry1=mysqli_query($conn,"select * from edu_add");
