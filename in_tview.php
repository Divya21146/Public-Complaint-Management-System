...
?> 
 ...
 <?php  
  ...
  $folder="upload/";
   $folder1="images/";
  $qry=mysqli_query($conn,"select * from transport where id='$id'");
  $update=mysqli_query($conn,"update transport set seen='$seen' where id = '$id'");
  ...
  if(isset($_POST['action']))
{
  ...
  $status="closed";
  $cseen="not_seen";
  $qry3 = mysqli_query($conn, "UPDATE transport SET status='$status',cseen='$cseen' WHERE id='$id' ");
$qry7= mysqli_query($conn,"select * from transport where id='$id'");
