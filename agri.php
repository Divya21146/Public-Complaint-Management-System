...
button:hover::before {
  ...
  <body style="background-color: #eaf6f6;">
    ...
    <li><a href="agri.php">Post complaint</a></li>
    <li><a href="afeed.php">Feedback</a></li>
  </ul>
  ...
  $qry=mysqli_query($conn,"insert into agriculture values('','$umail','$department','$cat', '$ctitle','$cdetail','$file_name','$district','$place','$status','$date','$seen','$cseen','$file_name1')");
if($qry)
{
...
?>
		...
		<form style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3); margin-top: 40px; margin-left:195px; margin-right:195px; border: 1px solid #ccc; padding: 30px; border-radius: 10px;" class="mb-4" method="post" enctype="multipart/form-data" action="agri.php" autocomplete="off">
