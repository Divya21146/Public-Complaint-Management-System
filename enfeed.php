...
button:hover::before {
  ...
  $qry=mysqli_query($conn,"insert into enfeed values ('','$umail','$feedback', '$date','$seen')");
    if($qry)
      {
...
?>
		...
		<form method="get" action="enfeed.php" autocomplete="off" style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3); margin-top: 50px; margin-left:300px; margin-right:300px; border: 1px solid #ccc; padding: 30px; border-radius: 10px;">
